...
def main():
    ...
    agent = Agent(num_states, num_actions, CAPACITY, BATCH_SIZE, HIDDEN_SIZE, LEARNING_RATE, GAMMA, ALPHA, BETA, 70, NUM_QUANTILES, DEVICE)
    ...
    for episode in range(NUM_EPISODES):
        ...
        for step in range(MAX_STEPS):
            ...
            if episode < 1:
               agent.memorize(state, action, state_next, reward, 1)
            else:
               agent.memorize(state, action, state_next, reward, -9.99e+8)
